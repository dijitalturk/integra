...
var Runner = function() {
  ...
  this.parallelize_level = Runner.TEST;
  ...
  this.parallelizeAtLevel = function(level) {
    this.parallelize_level = level;
    return this;
  }

  this.schedulerHints = function(schedulerHints) {
    this.schedulerHints = schedulerHints;
    return this;
  }

  this.add = function(suite_name, test_files) {
    console.log(this.schedulerHints)
  ...
  this.run = function(config_name, options) {  
    ...
    var test_suite_options = {
      ...
      , execute_serially: this.execute_serially
        // Execute parallel at "Test or File level"
