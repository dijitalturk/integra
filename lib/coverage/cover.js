...
var Cover = function Cover(options) {
	...
	this.onExit = function() {
		...
		for(var filename in __coverage__) {
			...
			// for(var statementLine in coverage.s) {
			// 	var statementCoverage = coverage.statementMap[statementLine];
			// 	console.dir(statementCoverage)
			// }
		}
