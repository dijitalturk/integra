...
var CoverageData = function(options) {
	...
	this.setCurrentDictionary = function(name, test) {
		logger(coverOptions.logLevel, 'info', f("setCurrentDictionary = %s", name));
	...
	this.unsetCurrentDictionary = function() {
		logger(coverOptions.logLevel, 'info', f("unsetCurrentDictionary"));
		// Copy the data
		copyData(dataDictionary, currentDictionary.data);
		// cleanupData(currentDictionary.data);
	}

	this.getDataDictionaries = function() {
		logger(coverOptions.logLevel, 'info', f("getDataDictionaries"));
	...
	Object.defineProperty(this, 'data', {
		get: function() {
			logger(coverOptions.logLevel, 'info', f("getData"));
			return dataDictionary;
		},
		enumerable: true
	});
